 ...
 */
export function getByEntityCode(
  catalog: AvailableDataCatalog,
  entityCode: string,
): AvailableDataEntry | undefined {
 ...
 */
export function groupByType(catalog: AvailableDataCatalog): {
  gdn: AvailableDataEntry[]
  std: AvailableDataEntry[]
} {
  return {
 ...
 */
export function getMunicipalitiesByCantonCode(
  catalog: AvailableDataCatalog,
): Map<string, AvailableDataEntry[]> {
