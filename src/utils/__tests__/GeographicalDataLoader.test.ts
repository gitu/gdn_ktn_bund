...
describe('GeographicalDataLoader', () => {
  ...
  describe('loadGeographicalDataCatalog', () => {
    ...
    it('should create proper indexes', async () => {
      ...
      expect(catalog.indexes.municipalityByGdnId.get('0100230')?.municipalityLongName).toBe(
        'Winterthur',
      )
  ...
  describe('error handling', () => {
    ...
    it('should handle HTTP errors', async () => {
      ...
      const loader = GeographicalDataLoader.getInstance()
      await expect(loader.loadGeographicalDataCatalog()).rejects.toThrow(
        'Failed to fetch cantons data: Not Found',
      )
    })
  })
})
