...
describe('StatsDataLoader', () => {
  ...
  describe('loadKtnData', () => {
    ...
    it('should handle non-existent stats ID', async () => {
      await expect(loader.loadKtnData('nonexistent', 2023)).rejects.toThrow(
        'Statistics entry not found',
      )
    })
  ...
  describe('utility methods', () => {
    ...
    it('should handle non-existent stats ID for available years', async () => {
      ...
      await expect(loader.getAvailableYears('nonexistent')).rejects.toThrow(
        'Statistics entry not found',
      )
    })
  })
