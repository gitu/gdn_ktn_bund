<template>
  <v-container fluid>
    ...
    <v-row>
      <v-col cols="12" md="4">
        <v-card class="h-100" hover @click="$router.push('/enriched-data')">
          ...
          <v-card-text>
            ...
            <v-chip-group>
              <v-chip size="small" color="primary" variant="outlined">Multi-language</v-chip>
              <v-chip size="small" color="primary" variant="outlined">Interactive</v-chip>
              <v-chip size="small" color="primary" variant="outlined">Detailed</v-chip>
            </v-chip-group>
          </v-card-text>
          <v-card-actions>
      ...
      <v-col cols="12" md="4">
        <v-card class="h-100" hover @click="$router.push('/comparison')">
          <v-card-title class="d-flex align-center">
            <v-icon color="success" class="mr-3">mdi-compare</v-icon>
            Comparison Tool
          </v-card-title>
          <v-card-text>
            <p>
            ...
            <v-chip-group>
              <v-chip size="small" color="success" variant="outlined">Side-by-side</v-chip>
              <v-chip size="small" color="success" variant="outlined">Scalable</v-chip>
              <v-chip size="small" color="success" variant="outlined">Visual</v-chip>
            </v-chip-group>
          </v-card-text>
          <v-card-actions>
      ...
      <v-col cols="12" md="4">
        <v-card class="h-100" hover @click="$router.push('/csv-test')">
          <v-card-title class="d-flex align-center">
            <v-icon color="info" class="mr-3">mdi-file-table</v-icon>
            CSV Test Page
          </v-card-title>
          <v-card-text>
            <p>
            ...
            <v-chip-group>
              <v-chip size="small" color="info" variant="outlined">Testing</v-chip>
              <v-chip size="small" color="info" variant="outlined">Validation</v-chip>
              <v-chip size="small" color="info" variant="outlined">Development</v-chip>
            </v-chip-group>
          </v-card-text>
          <v-card-actions>
          ...
          <v-card-text>
            <v-row>
              <v-col cols="12" md="3" class="text-center">
                <div class="text-h4 text-primary">{{ entityCount }}</div>
                <div class="text-subtitle-1">Total Entities</div>
              </v-col>
              <v-col cols="12" md="3" class="text-center">
                <div class="text-h4 text-success">{{ availableYears.length }}</div>
                <div class="text-subtitle-1">Available Years</div>
              </v-col>
              <v-col cols="12" md="3" class="text-center">
                <div class="text-h4 text-info">4</div>
                <div class="text-subtitle-1">Languages</div>
              </v-col>
              <v-col cols="12" md="3" class="text-center">
                <div class="text-h4 text-warning">{{ latestYear }}</div>
                <div class="text-subtitle-1">Latest Year</div>
              </v-col>
            </v-row>
          </v-card-text>
        </v-card>
